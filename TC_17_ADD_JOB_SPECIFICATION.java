...
public class TC_17_ADD_JOB_SPECIFICATION {
	...
	public static void main(String[] args) {
		...
		WebElement jS=driver.findElement(By.xpath("//*[@id='admin']/ul/li[2]/ul/li[1]/a/span"));
		...
		driver.findElement(By.id("txtFieldName")).sendKeys("shejal mule");
        driver.findElement(By.id("txtDesc")).sendKeys("tester");
        driver.findElement(By.id("txtDuties")).sendKeys("SOFTWARE TESTING");
