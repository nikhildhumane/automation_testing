...
public class TC_15_EDIT_JOB_TITLES {
	...
	public static void main(String[] args) {
		...
		s.selectByIndex(1);
		driver.findElement(By.id("loc_name")).sendKeys("JOB001");
		driver.findElement(By.linkText("JOB001")).click();
		driver.findElement(By.xpath("/html/body/div/div[2]/form/div[3]/div[1]/input[1]")).click();
		driver.findElement(By.name("butUnAssEmploymentStatus")).click();
		driver.findElement(By.id("txtJobTitleComments")).sendKeys("freshersnew");
