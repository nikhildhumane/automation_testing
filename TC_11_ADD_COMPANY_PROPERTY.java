...
public class TC_11_ADD_COMPANY_PROPERTY {
	...
	public static void main(String[] args) {
		...
		cmpnyprop.click();
		driver.switchTo().frame("rigtMenu");
		driver.findElement(By.xpath("/html/body/div/div[2]/div[2]/div[1]/input")).click();
		driver.findElement(By.id("txtPropertyName")).sendKeys("testing");
