...
public class TC_18_EDIT_JOB_SPECIFICATION {
	...
	public static void main(String[] args) {
		...
		s.selectByIndex(1);
		driver.findElement(By.id("loc_name")).sendKeys("002");
		driver.findElement(By.linkText("002")).click();
		driver.findElement(By.xpath("/html/body/div/div[2]/form/div[3]/div[1]/input[1]")).click();
		driver.findElement(By.id("txtDesc")).sendKeys("freshersnew");
