...
public class TC_04_EDIT_EMPLOYEE_DETAILS {
...
driver.findElement(By.linkText("mrunali vijay talwekar")).click();
driver.findElement(By.id("btnEditPers")).click();
driver.findElement(By.name("txtEmpFirstName")).sendKeys("vivan");
driver.findElement(By.id("txtEmpLastName")).sendKeys("darvekar");
//WebElement nationality=driver.findElement(By.xpath("//*[@id='cmbNation']"));
//Select m=new Select(nationality);
//m.selectByIndex(1);
driver.findElement(By.id("DOB")).sendKeys("08/06/1999");
WebElement marital=driver.findElement(By.name("cmbMarital"));
Select u=new Select(marital);
u.selectByIndex(2);
driver.findElement(By.id("gender2")).click();
driver.findElement(By.name("chkSmokeFlag")).click();
driver.findElement(By.id("btnEditPers")).click();
