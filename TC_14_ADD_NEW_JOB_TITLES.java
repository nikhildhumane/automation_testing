...
public class TC_14_ADD_NEW_JOB_TITLES {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("txtJobTitleName")).sendKeys("shejal mule");
        driver.findElement(By.id("txtJobTitleDesc")).sendKeys("tester");
        driver.findElement(By.id("txtJobTitleComments")).sendKeys("fresher");
